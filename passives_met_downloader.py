...
passives = pd.read_excel(r"C:\Users\firanskib\Documents\Python Scripts\oesg_mercury_analysis\assets\passives_stations.xlsx", usecols=['passives_site_name', 'site_latdecd','site_londecd'])
stations = pd.read_csv(r"C:\Users\firanskib\Documents\Python Scripts\oesg_mercury_analysis\assets\isd-history.csv", usecols=['USAF','WBAN','STATION NAME','LAT','LON'], dtype={'USAF': str, 'WBAN': str})
...
# -------------------------
output_folder = Path(r"C:\Users\firanskib\Documents\Python Scripts\oesg_mercury_analysis\assets")
output_folder.mkdir(exist_ok=True)

years = range(2020, 2026)  # 2020 to 2025 (adjust as needed)
