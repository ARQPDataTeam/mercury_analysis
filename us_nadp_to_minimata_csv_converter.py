...
sites_filename='C:/Users/firanskib/OneDrive - EC-EC/mercury/US_MDN_Files/mdn_test.csv'
...
for index_item in mercury_sites_df.index:
    ...
    mercury_metatada_header_df.loc['*SITE LATITUE UNITS (DECIMAL degrees)',1]='DECIMAL'
    mercury_metatada_header_df.loc['*SITE LONGITUDE',1]=mercury_sites_df.loc[index_item,'longitude']
    mercury_metatada_header_df.loc['*SITE LONGITUDE UNITS  (DECIMAL degrees)',1]='DECIMAL'
    if mercury_sites_df.loc[index_item,'siteClass']=='I':
        mercury_metatada_header_df.loc['*SITE CHARACTERISTICS',1]= 'Remote or unpopulated areas'
    elif mercury_sites_df.loc[index_item,'siteClass']=='R':
        mercury_metatada_header_df.loc['*SITE CHARACTERISTICS',1]= 'Low population density areas (<500 persons per square Km)'
    elif mercury_sites_df.loc[index_item,'siteClass']=='U':
        mercury_metatada_header_df.loc['*SITE CHARACTERISTICS',1]= 'High population density areas (>500 persons per square Km)'
    else:
        continue
